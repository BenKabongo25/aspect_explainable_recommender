...
class AURASharedSelfAttention(nn.Module):
    """ AURA with shared self attention """
...
class AURANotSharedSelfAttention(nn.Module):
    """ AURA with not shared self attention """
...
class AURASharedCrossAttention(nn.Module):
    """ AURA with shared cross-attention """
...
class AURANotSharedCrossAttention(nn.Module):
    """ AURA with not shared cross-attention"""
...
class AURASkipConnection(nn.Module):
