...
def get_model(config):
    if config.ablation == "skip_connection": # w/o skip connection
    ...
    elif config.ablation == "self_attention": # w self attention
        model = AURASelfAggregation
    else:
        model = AURA
    return model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ablation", type=str, default="",
        choices=["", "skip_connection", "pooling", "aspects_embeddings", "aspects_ratings", "aggregation", "self_attention"])
