...
![Review](AURA/images/review_ex/review_ex2.svg)
**Figure 1: Example of a multi-aspect review from the TripAdvisor hotel dataset.** 

## Model

![AURA Overview](AURA/images/aura_all.svg)
...
![AURA Rating Module](AURA/images/aura.svg)
**Figure 3: AURA Rating module.**


![AURA Review Module](AURA/images/aura_review.svg)
...
![Multi-Aspects Rating Module](AURA/images/multi_aspects_mlp/multi_aspects_mlp.svg)
...
| 32    | 0.8417      | 0.8309 (0.0743)     | 0.6282      | 0.6123 (0.0536)     | 0.4083      | 0.4568 (0.0356)     | 0.2974      | 0.3478 (0.0322)     |
| 64    | 0.8025      | 0.8039 (0.0730)     | 0.5778      | 0.5834 (0.0518)     | 0.4064      | 0.4560 (0.0369)     | **0.2942*** | 0.3468 (0.0327)*    |
| 128   | 0.7299      | 0.7450 (0.0689)     | 0.4878      | 0.5200 (0.0532)     | **0.4044**  | **0.4531 (0.0364)** | 0.2957*     | 0.3438 (0.0320)*    |
| 256   | 0.6669      | 0.6877 (0.0640)     | **0.4197**  | 0.4552 (0.0488)*    | 0.4060      | 0.4574 (0.0389)     | 0.2964*     | **0.3430 (0.0321)** |
| 512   | **0.6772**  | **0.6689 (0.0612)** | 0.4400      | **0.4388 (0.0390)** | 0.4157      | 0.4678 (0.0383)     | 0.3037      | 0.3514 (0.0313)     |
| ===== | =====       | ==============      | =====       | ==============      | =====       | ==============      | =====       | ==============      |

| Hotels   | $d$   | Overall    | Aspects             | Cleanliness | Location | Room   | Service | Sleep  | Value  |
| -------- | ----- | ---------- | ------------------- | ----------- | -------- | ------ | ------- | ------ | ------ |
| **RMSE** | 32    | 0.8417     | 0.8309 (0.0743)     | 0.7620      | 0.7030   | 0.8443 | 0.9094  | 0.8743 | 0.8923 |
|          | 64    | 0.8025     | 0.8039 (0.0730)     | 0.7355      | 0.6776   | 0.8173 | 0.8737  | 0.8538 | 0.8654 |
|          | 128   | 0.7299     | 0.7450 (0.0689)     | 0.6820      | 0.6255   | 0.7545 | 0.8032  | 0.7921 | 0.8125 |
|          | 256   | 0.6669     | 0.6877 (0.0640)     | 0.6284      | 0.5797   | 0.6922 | 0.7599  | 0.7362 | 0.7300 |
|          | 512   | **0.6772** | **0.6689 (0.0612)** | 0.6355      | 0.5534   | 0.6656 | 0.7313  | 0.7076 | 0.7199 |
| =====    | ===== | =====      | ==============      | =====       | =====    | =====  | =====   | =====  | =====  |
| **MAE**  | 32    | 0.6282     | 0.6123 (0.0536)     | 0.5499      | 0.5287   | 0.6296 | 0.6585  | 0.6372 | 0.6699 |
|          | 64    | 0.5778     | 0.5834 (0.0518)     | 0.5193      | 0.5054   | 0.5991 | 0.6227  | 0.6150 | 0.6392 |
|          | 128   | 0.4878     | 0.5200 (0.0532)     | 0.4578      | 0.4352   | 0.5385 | 0.5657  | 0.5587 | 0.5643 |
|          | 256   | **0.4197** | 0.4552 (0.0488)*    | 0.4006      | 0.3800   | 0.4656 | 0.5171  | 0.4876 | 0.4805 |
|          | 512   | 0.4400     | **0.4388 (0.0390)** | 0.4526      | 0.3552   | 0.4350 | 0.4552  | 0.4682 | 0.4669 |
| =====    | ===== | =====      | ==============      | =====       | =====    | =====  | =====   | =====  | =====  |

| Beer     | $d$   | Overall     | Aspects             | Appearance | Aroma  | Palate | Taste  |
| -------- | ----- | ----------- | ------------------- | ---------- | ------ | ------ | ------ |
| **RMSE** | 32    | 0.4083      | 0.4568 (0.0356)     | 0.4841     | 0.4170 | 0.4996 | 0.4265 |
|          | 64    | 0.4064      | 0.4560 (0.0369)     | 0.4839     | 0.4166 | 0.5008 | 0.4228 |
|          | 128   | **0.4044**  | **0.4531 (0.0364)** | 0.4853     | 0.4119 | 0.4931 | 0.4220 |
|          | 256   | 0.4060      | 0.4574 (0.0389)     | 0.4914     | 0.4134 | 0.5005 | 0.4241 |
|          | 512   | 0.4157      | 0.4678 (0.0383)     | 0.4961     | 0.4288 | 0.5150 | 0.4315 |
| =====    | ===== | =====       | ==============      | =====      | =====  | =====  | =====  |
| **MAE**  | 32    | 0.2974      | 0.3478 (0.0322)     | 0.3749     | 0.3107 | 0.3843 | 0.3214 |
|          | 64    | **0.2942*** | 0.3468 (0.0327)*    | 0.3749     | 0.3107 | 0.3836 | 0.3182 |
|          | 128   | 0.2957*     | 0.3438 (0.0320)*    | 0.3747     | 0.3090 | 0.3767 | 0.3148 |
|          | 256   | 0.2964*     | **0.3430 (0.0321)** | 0.3729     | 0.3045 | 0.3764 | 0.3180 |
|          | 512   | 0.3037      | 0.3514 (0.0313)     | 0.3747     | 0.3213 | 0.3899 | 0.3198 |
| =====    | ===== | =====       | ==============      | =====      | =====  | =====  | =====  |
#### Review generation
